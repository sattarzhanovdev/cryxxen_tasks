...
export const api = {
  getTasks: () => axios.get(`${api_url}/issues?fields=id,summary,project(name, id),customFields(id,name,value(avatarUrl,buildLink,color(id),text,fullName,id,isResolved,localizedName,login,minutes,name,presentation,text)),comments(text)`, {headers}),
  ...
  getProjectsPasswords: () => axios.get('https://cryxxen-d12e0-default-rtdb.asia-southeast1.firebasedatabase.app/data.json'),
  changePassword: (id, data) => axios.put(`https://cryxxen-d12e0-default-rtdb.asia-southeast1.firebasedatabase.app/data/${id}.json`, data)
}